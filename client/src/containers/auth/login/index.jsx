...
const Login = () => {
  ...
  const [isAppleLoading, setIsAppleLoading] = useState(false); // Loading state for Apple auth
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      // Firebase Apple sign-in with popup
       // Set persistence based on rememberMe selection
       await setPersistence(
        auth,
        rememberMe ? browserLocalPersistence : browserSessionPersistence
      ...
      setSnackbarMessage("Apple sign-in failed. Please try again.");
      setSnackbarSeverity("error");
      setSnackbarOpen(true);
    } finally {
